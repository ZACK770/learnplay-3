...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'auth.login.subtitle': 'היכנס כדי להמשיך במסע הלמידה שלך.',
    'auth.login.submit': 'התחבר',
    'auth.login.toggle': 'עדיין אין לך חשבון? הירשם עכשיו',
    'auth.register.title': 'יצירת חשבון חדש',
    'auth.register.subtitle': 'הצטרף לאלפי משפחות שכבר לומדות ונהנות.',
    'auth.register.submit': 'צור חשבון',
    'auth.register.toggle': 'כבר יש לך חשבון? התחבר כאן',
    'auth.field.name': 'שם מלא',
    'auth.field.email': 'כתובת אימייל',
    'auth.field.password': 'סיסמה',
    'auth.divider': 'או המשיכו עם',
    'auth.google.submit': 'התחברות עם Google',
    'auth.error.name': 'אנא הזן שם מלא',
    'auth.error.general': 'נראה שיש בעיה בפרטים, נסה שנית',
  },
  en: {
    ...
    'auth.login.toggle': 'Don\'t have an account? Register now',
    'auth.register.title': 'Create New Account',
    'auth.register.subtitle': 'Join thousands of families already learning and having fun.',
    'auth.register.submit': 'Create Account',
    'auth.register.toggle': 'Already have an account? Sign in here',
    'auth.field.name': 'Full Name',
    'auth.field.email': 'Email Address',
    'auth.field.password': 'Password',
    'auth.divider': 'Or continue with',
    'auth.google.submit': 'Sign in with Google',
    'auth.error.name': 'Please enter your full name',
    'auth.error.general': 'Invalid credentials, please try again',
  },
  ar: {
